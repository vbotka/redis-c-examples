...
htmlhelp_basename = 'redis-c-examples-doc'
...
latex_documents = [
    (master_doc, 'redis-c-examples.tex', 'redis-c-examples Documentation',
...
man_pages = [
    (master_doc, 'redis-c-examples', 'redis-c-examples Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'redis-c-examples', 'redis-c-examples Documentation',
     author, 'redis-c-examples', 'One line description of project.',
     'Miscellaneous'),
]
